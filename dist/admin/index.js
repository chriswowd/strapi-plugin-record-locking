...
function EntityLock() {
  ...
  if (!lockStatus)
    return null;
  return lockStatus.isLocked && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { defaultOpen: true, onClose: null, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
